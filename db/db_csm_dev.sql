...
CREATE TABLE `tb_customer_car` (
  ...
  `s_ref_car` varchar(50) NOT NULL COMMENT 'รหัสอ้างอิงผูกกับข้อมูลลูกค้ากับข้อมูลรถ',
  `s_car_code` varchar(50) NOT NULL COMMENT 'รหัสอ้างอิงข้อมูลรุ่นรถ',
  `d_ins_exp` date NOT NULL,
  `s_type_capital` varchar(100) NOT NULL,
...
(2, 6, 'aaa', 'sss', '0987654321', 'a@a.com', 's1.pdf', 's2.pdf', '2017-11-18 09:57:18', '2017-11-18 09:57:18', 'user', 'user', 'A'),
...
-- Error reading data: (#2006 - MySQL server has gone away)
...
--
ALTER TABLE `tb_insurance_trans`
  MODIFY `i_ins_trans` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `tb_vat`
  MODIFY `i_vat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;<div class="error"><h1>Error</h1><p><strong>SQL query:</strong>
<a href="db_sql.php?sql_query=SET+time_zone+%3D+%22SYSTEM%22&amp;show_query=1&amp;db=db_csm&amp;token=fc324988396c1f104d6dd0ed3cfae843"><span class="nowrap"><img src="themes/dot.gif" title="Edit" alt="Edit" class="icon ic_b_edit" />&nbsp;Edit</span></a>    </p>
<p>
<code class="sql"><pre>
