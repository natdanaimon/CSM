...
if ($_GET[id] == NULL && $_GET[func] != "add") {
    echo header("Location: ui_portfolio.php");
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="ui_news.php"><?= $_SESSION[ui_portfolio] ?></a>
                                    <i class="fa fa-circle" style="color:  #00FF00;"></i>
                                </li>
                                <li>
                                    <?= $tt_header ?>
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group form-md-line-input has-success" id="div-sv-src">
                                                    ...
                                                    <label for="form_control_1"><?= $_SESSION[lb_setPort_subject] ?> <span class="required">*</span></label>          
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input has-success" >
                                                    ...
                                                    <label for="form_control_1"><?= $_SESSION[lb_setPort_detail] ?> <span class="required">*</span>
                                                    </label>          
                                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet-body form">
                                            <div class="form-actions noborder">
                                                <a href="ui_portfolio.php"> <button type="button" class="btn default"><?= $_SESSION[btn_cancel] ?></button></a>
        ...
        <?php $_SESSION["folder_upload"] = "portfolioDetail" ?>
        <script>
        ...
        <script src="js/action/ui/portfolioManage.js" type="text/javascript"></script>
