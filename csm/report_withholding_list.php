          ...
          <div class="page-content">
            ...
            <div class="page-bar">
              <ul class="page-breadcrumb">
                ...
                <li>
                  <a href="report_quotation_list.php">หักภาษี ณ ที่จ่าย</a>
                </li>
              </ul>
                ...
                <div class="portlet light bordered">
                  <div class="portlet-title">
                    <div class="caption font-dark">
                      ...
                      <span class="caption-subject bold uppercase">หักภาษี ณ ที่จ่าย</span>
                    </div>
                    <div class="actions">
                      <a href="report_withholding.php">
                        <button id="sample_editable_1_new" class="btn sbold green"><i class="fa fa-plus"></i> สร้างหักภาษี ณ ที่จ่าย
                        </button>
                      </a>
                    </div>
                  </div>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
    ...
    <script src="js/action/report/withholding_list.js" type="text/javascript"></script>
    <script>
