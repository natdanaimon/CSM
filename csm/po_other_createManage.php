                                                ...
                                                <div class="portlet-body form">
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group form-md-line-input has-success">
                                                                    <input type="text" class="form-control bold" id="s_po_other_order" name="s_po_other_order" <?= $disableElement ?>>
                                                        ...
                                                        <div class="col-md-4">
                                                                <div class="form-group form-md-line-input has-success">
                                                                    <input type="number" class="form-control bold required" id="i_other_price" name="i_other_price" >
                                                                    <label for="form_control_1"><?= $_SESSION[tb_po_price] ?> <span class="required"></span></label>          
                                                                </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                                <div class="form-group form-md-line-input has-success">
                                                                    <input type="number" class="form-control bold required" id="i_other_amount" name="i_other_amount" >
                                                                    <label for="form_control_1"><?= $_SESSION[tb_po_amount] ?> <span class="required"></span></label>          
                                                                </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                                <div class="form-group form-md-line-input has-success">
                                                                    <input type="number" class="form-control bold required" id="i_other_store" name="i_other_store" >
