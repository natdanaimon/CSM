        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset mt-login-5-bsfix">
                    <div class="login-bg" style="background-image:url(../assets/pages2/img/login/bg1.jpg)">
...
<!--        <div>
        ...
        <script src=../assets/pages2/scripts/login-5.min.jss" type="text/javascript"></script>
