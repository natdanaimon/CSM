...
if ($_GET[id] == NULL && $_GET[func] != "add") {
    echo header("Location: set_compulsory.php");
}
?>
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="set_compulsory.php"><?= $_SESSION[set_compu] ?></a>
                                    <i class="fa fa-circle" style="color:  #00FF00;"></i>
                                </li>
                                <li>
                                    <?= $tt_header ?>
                                        ...
                                        <div class="portlet-body form">
                                            <div class="form-body">
                                                <div class="form-group form-md-line-input has-success">
                                                    ...
                                                    <label for="form_control_1"><?= $_SESSION[lb_setCompu_name] ?> <span class="required">*</span></label>          
                                                </div>
                                        ...
                                        <div class="portlet-body form">
                                            <div class="form-body">
                                                <div class="form-group form-md-line-input has-success">
                                                    ...
                                                    <label for="form_control_1"><?= $_SESSION[lb_setCompu_amount] ?> <span class="required">*</span></label>          
                                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet-body form">
                                            <div class="form-actions noborder">
                                                <a href="set_compulsoryManage.php"> <button type="button" class="btn default"><?= $_SESSION[btn_cancel] ?></button></a>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/setting/compulsoryManage.js" type="text/javascript"></script>
        <script>
                                                    var keyEdit = "<?= $_GET[id] ?>";
        </script>
        <script>
