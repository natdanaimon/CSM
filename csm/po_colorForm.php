...
$strSql = " select list.* ";
$strSql .= " FROM tb_po_color_list list  WHERE ref_id = '" . $_GET[id] . "' ";
...
<html lang="en">
  ...
  <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    ...
                                    <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?=date("d-m-Y") ?>"  style="width: 100% !important;">
                                      ...
                                      <input type="text" class="form-control" readonly name="d_order" id="d_order" value="<?=$po_color[0][d_color_order] ?>" >
                                    </div>
                                  </div>
                                  <div class="col-md-7">
                                    <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group form-md-line-input has-success">
                                      ...
                                      <label for="form_control_1"><?=$_SESSION[tb_po_code] ?> <span class="required">*</span></label>          
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-md-line-input has-success">
                                      <input type="text" class="form-control bold" id="s_name" name="s_name" >
                                      <label for="form_control_1"><?=$_SESSION[color_name] ?> <span class="required">*</span></label>          
                                    </div>
                                  </div>
                                  <div class="col-md-4">
                                    <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    ...
                                    <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?=date("d-m-Y") ?>"  style="width: 100% !important;">
                                      ...
                                      <input type="text" class="form-control" readonly name="d_receive" id="d_receive" value="<?=$po_color[0][d_color_order] ?>"  <?=$disableView ?>>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    ...
                                    <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?=date("d-m-Y") ?>"  style="width: 100% !important;">
                                      ...
                                      <input type="text" class="form-control" readonly name="d_withdraw" id="d_withdraw" value="<?=$po_color[0][d_color_order] ?>"  <?=$disableView ?>>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-md-line-input has-success">
    ...
    <script src="js/action/po/po_colorForm.js?v=<?=JS_VERSION; ?>" type="text/javascript"></script>
    ...
    <script>
      $('#btn_add_order').click(function () {
        ...
        $.ajax({
          type: 'POST',
          url: 'controller/po/createControllerColor.php',
          data: {
            d_order: d_order
            , i_shop: i_shop
            , s_code: s_code
