          ...
          <div class="page-content">
            ...
            <div class="page-bar">
              <ul class="page-breadcrumb">
                ...
                <li>
                  <a href="report_invoice.php?id=<?=$i_cust_car;?>">บิลเงินสด</a>
            ...
            $.ajax({
              ...
              success: function (data) {
                ...
                if (res[0] == "0000") {
                  ...
                  var url_blank = 'report/receipt.php?id=' + res[2];
                  window.open(url_blank, '_blank');
                  location.replace('report_receipt_list.php');
