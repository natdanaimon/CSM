...
if ($_GET[id] == NULL && $_GET[func] != "add") {
    echo header("Location: set_carsub.php");
}
?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet-body form">
                                            <div class="form-actions noborder">
                                                <a href="set_carsub.php"> <button type="button" class="btn default"><?= $_SESSION[btn_cancel] ?></button></a>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/setting/carsubManage.js" type="text/javascript"></script>
        <script>
                                                    var keyEdit = "<?= $_GET[id] ?>";
        </script>
        <script>
