                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="set_carbrand.php"><?= $_SESSION[set_brand] ?></a>
                                </li>
                            </ul>
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"><?= $_SESSION[tt_mg_carbrand] ?></span>
                                        </div>
                                        <div class="actions">
                                        ...
                                        <div class="table-toolbar">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6" align="left"  <?= $hidden ?>>
                                                    <div class="btn-group">
                                                        <a href="set_carbrandManage.php?func=add">
...
<!--                                                            <i class="fa fa-minus"></i>-->
                                                ...
                                                <div class="col-md-6" align="right"  <?= $hidden ?>>
                                                    ...
                                                    <div class="btn-group">
                                                        <a href="excel/templated brand.xlsx" >
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/setting/carbrand.js" type="text/javascript"></script>
        <script>
