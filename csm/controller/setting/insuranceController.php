...
class insuranceController {
    ...
    public function __construct() {
        ...
        include '../../service/setting/insuranceService.php';
    }
    ...
    public function delete($seq) {
        ...
        if ($service->delete($db, $seq)) {
            ...
            $upload->set_path("../../upload/compInsurance/");
    ...
    public function edit($info) {
        if ($this->isValid($info)) {
            ...
            $service = new insuranceService();
            $doc = new upload();
            $doc->set_path("../../upload/compInsurance/");
    ...
    public function isValid($info) {
        ...
        if ($util->isEmpty($info[s_comp_th])) {
            $return2099 = eregi_replace("field", $_SESSION['lb_setInsurance_th'], $return2099);
            echo $return2099;
...
//            echo $_SESSION['cd_2207'];
    ...
    public function deleteTempFile($db) {
        $temp = new upload();
        $svTemp = new insuranceService();
        $temp->set_path("../../upload/compInsurance/");
