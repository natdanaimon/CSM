...
class dmgController {
    ...
    public function __construct() {
        ...
        include '../../service/setting/dmgService.php';
    }

    public function dataTable() {
        $service = new dmgService();
    ...
    public function isValid($info) {
        ...
        $util = new Utility();
        if ($util->isEmpty($info[s_dmg_th])) {
            $return2099 = eregi_replace("field", $_SESSION['lb_setDmg_th'], $return2099);
            echo $return2099;
