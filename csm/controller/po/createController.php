...
class createController {
    ...
    public function isValid($info) {
        ...
        } else if ($util->isEmpty($info[s_po_spare_order])) {
            $return2099 = eregi_replace("field", $_SESSION['tb_po_spare_order'], $return2099);
            echo $return2099;
        } 
        else if ($util->isEmpty($info[i_spare_shop])) {
            $return2099 = eregi_replace("field", $_SESSION['tb_po_spare_shop'], $return2099);
            echo $return2099;
        } 
        else if ($util->isEmpty($info[i_spare_price])) {
            $return2099 = eregi_replace("field", $_SESSION['tb_po_spare_price'], $return2099);
            echo $return2099;
        }
        else if ($util->isEmpty($info[i_spare_amount])) {
            $return2099 = eregi_replace("field", $_SESSION['tb_po_spare_amount'], $return2099);
            echo $return2099;
        }
        else {
            $intReturn = TRUE;
