...
$controller = new gameCSController();
switch ($info[func]) {
    case "dataTable":
...
class gameCSController {

    public function dataTable() {
        include '../service/gameCSService.php';
        $service = new gameCSService();
        $_dataTable = $service->dataTable();
        if ($_dataTable != NULL) {
            foreach ($_dataTable as $key => $value) {
                $_dataTable[$key]['f_amount_current'] = $service->getAmountCurrent($_dataTable[$key]['f_amount_base'],$_dataTable[$key]['i_game']);
            }
