...
class portfolioController {
    ...
    public function __construct() {
        ...
        include '../../service/ui/portfolioService.php';
    }
    ...
    public function delete($seq) {
        ...
        if ($service->delete($db, $seq)) {
            ...
            $upload->set_path("../../upload/portfolio/");
    ...
    public function isValid($info) {
        ...
        if ($util->isEmpty($info[i_index])) {
            ...
            $return2099 = eregi_replace("field", $_SESSION['lb_setPort_subject'], $return2099);
            echo $return2099;
        } else if ($util->isEmpty($info[s_detail])) {
            $return2099 = eregi_replace("field", $_SESSION['lb_setPort_detail'], $return2099);
            echo $return2099;
    ...
    public function deleteTempFile($db) {
        $temp = new upload();
        $svTemp = new portfolioService();
        $temp->set_path("../../upload/portfolio/");
