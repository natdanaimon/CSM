...
class knowController {
    ...
    public function __construct() {
        ...
        include '../../service/ui/knowService.php';
    }
    ...
    public function isValid($info) {
        ...
        if ($util->isEmpty($info[i_index])) {
            ...
            $return2099 = eregi_replace("field", $_SESSION['lb_setKnow_subject'], $return2099);
            echo $return2099;
        } else if ($util->isEmpty($info[s_detail])) {
            $return2099 = eregi_replace("field", $_SESSION['lb_setKnow_detail'], $return2099);
            echo $return2099;
    ...
    public function deleteTempFile($db) {
        $temp = new upload();
        $svTemp = new knowService();
        $temp->set_path("../../upload/know/");
