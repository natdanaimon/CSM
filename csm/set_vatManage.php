...
if ($_GET[id] == NULL && $_GET[func] != "add") {
    echo header("Location: set_vat.php");
}
?>
                                        ...
                                        <div class="portlet-body form">
                                            <div class="form-body">
                                                <div class="form-group form-md-line-input has-success">
                                                    <input type="number" class="form-control bold" id="f_vat" name="f_vat">
                                                    <label for="form_control_1"><?= $_SESSION[lb_setVat_vat] ?> <span class="required">*</span></label>          
                                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet-body form">
                                            <div class="form-actions noborder">
                                                <a href="set_vat.php"> <button type="button" class="btn default"><?= $_SESSION[btn_cancel] ?></button></a>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/setting/vatManage.js" type="text/javascript"></script>
        <script>
                                                    var keyEdit = "<?= $_GET[id] ?>";
        </script>
        <script>
