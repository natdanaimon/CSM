                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div id="div-bonus" style="display: block;" >
                                                        ...
                                                        <div style="display: block;" class="form-group form-md-line-input has-success " >
                                                        <input 
                                                            ng-keyup="changeSelected()" 
                                                            type="number" min="0" class="form-control bold" id="f_special_bonus" name="f_special_bonus" 
                                                            value="0"
                                                            >
                            ...
                            <div class="col-md-12">
                                <div class="portlet-body form">
                                    <div class="form-actions noborder">
                                        ...
                                        <button type="button" class="btn blue" onclick="save()" <?= ($_GET[func] == "edit" ? $hidden : "") ?> ><?= $_SESSION[btn_submit] ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
