                    ...
                    <div class="page-content" style="padding: 0px;">
                        ...
                        <div class="page-bar" style="display: none;">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <h3>ระบบแจ้งสถานะงานซ่อม</a> :: ประจำวันที่ <?=date('d-m-Y');?></h3>
                                </li>
                            </ul>
    ...
    mso-pattern: black none;
												...
												<table width="100%" style="position: fixed;margin-top: 154px;">
													<tr height="115" style="mso-height-source:userset;height:86.25pt">
													  <td colspan="3" class="xl128"><?=date('d');?> <?=$thaimonth[date('m')-1];?> <?=date('Y');?></td>
													  <td colspan="3"class="xl131" id="time_now" width="33%" ><?=date('H:i:s');?></td>
													  <td colspan="2" height="115" class="xl132"   style="height:86.25pt;" align="left" valign="top">
													  งานส่งมอบวันนี้ 15 คัน
													  </td>
													</tr>
												</table>                         
												<!-- ****************************  -->                            
														...
														<tr>
															...
															if($objArr[7] == 'ปกติ'){
																...
																<?php
																	...
																	?>
																<font style="color: #38c566;font-weight: bold;"><?=$objArr[7];?></font>
																<?php
																}
