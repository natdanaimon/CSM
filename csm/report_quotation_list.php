          ...
          <div class="page-content">
            ...
            <div class="page-bar">
              <ul class="page-breadcrumb">
                ...
                <li>
                  <a href="report_quotation_list.php">ใบเสนอราคา</a>
                </li>
              </ul>
                ...
                <div class="portlet light bordered">
                  <div class="portlet-title">
                    <div class="caption font-dark">
                      ...
                      <span class="caption-subject bold uppercase">ใบเสนอราคา</span>
                    </div>
                    <div class="actions">
                      <a href="report_quotation.php">
                        <button id="sample_editable_1_new" class="btn sbold green"><i class="fa fa-plus"></i> สร้างใบเสนอราคา
                        </button>
                      </a>
                    </div>
                  </div>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
    ...
    <script src="js/action/report/quotation_list.js" type="text/javascript"></script>
    <script>
