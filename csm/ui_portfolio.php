                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"><?= $_SESSION[tt_mg_portfolio] ?></span>
                                        </div>
                                        <div class="actions">
...
<!--                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-12" align="left" <?= $hidden ?>>
                                                    <div class="btn-group">
                                                        <a href="ui_portfolioManage.php?func=add">
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/ui/portfolio.js" type="text/javascript"></script>
