...
$strSql = " select list.* ";
$strSql .= " FROM tb_po_spare_list list  WHERE ref_id = '" . $_GET[id] . "' ";
                      ...
                      <div class="portlet light bordered">
                        <div class="portlet-body form">
                          <div class="form-body" >
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    ...
                                    <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?=date("d-m-Y") ?>"  style="width: 100% !important;">
                                      ...
                                      <input type="text" class="form-control" readonly name="d_order" id="d_order" value="<?=$po_spare[0][d_spare_order] ?>" >
                                    </div>
                                  </div>
                                  <div class="col-md-7">
                                    <div class="form-group form-md-line-input has-success">
                            ...
                            <div class="row">
                              <!-- Receive & withdraw -->
                              <div class="col-md-12" id="div_withdraw<?=time(); ?>">
                                <!-- Receive -->
                                <div class="row">
                                  <div class="col-md-3">
                                    ...
                                    <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?=date("d-m-Y") ?>"  style="width: 100% !important;">
                                      ...
                                      <input type="text" class="form-control" readonly name="d_receive" id="d_receive" value="<?=$po_spare[0][d_spare_receive] ?>"  <?=$disableView ?>>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-md-line-input has-success">
                                ...
                                <div class="row" >
                                  <div class="col-md-3">
                                    ...
                                    <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?=date("d-m-Y") ?>"  style="width: 100% !important;">
                                      ...
                                      <input type="text" class="form-control" readonly name="d_withdraw" id="d_withdraw" value="<?=$po_spare[0][d_spare_receive] ?>"  <?=$disableView ?>>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group form-md-line-input has-success">
