                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"><?= $_SESSION[tt_mg_vip_pass] ?></span>
                                        </div>
                                        <div class="actions">
                                        ...
                                        <div class="table-toolbar">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6" align="left"  <?= $hidden ?>>
                                                    <div class="btn-group">
                                                        <div class="btn-group">
                                                            <a href="cs_vip_pass_manage.php?func=add">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th> <?= $_SESSION[lb_cs_username_file] ?> </th>
                                                    <th> <?= $_SESSION[lb_cs_username_login] ?> </th>
                                                    <th> <?= $_SESSION[lb_cs_password] ?> </th>
...
<!--        <script src="../assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.js" type="text/javascript"></script>
        ...
        <script src="js/action/cs_vip_pass.js" type="text/javascript"></script>
