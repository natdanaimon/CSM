...
if ($_GET[id] == NULL && $_GET[func] != "add") {
  echo header("Location: re_success.php");
}
          ...
          <div class="page-content">
            ...
            <div class="page-bar">
              <ul class="page-breadcrumb">
                ...
                <li>
                  <a href="re_process.php"><?=$_SESSION[re_success]?></a>
                  <i class="fa fa-circle" style="color:  #00FF00;"></i>
                </li>
                <li>
                  <?=$tt_header?>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                <div class="portlet box green">
                  ...
                  <div class="portlet-body form" id="step2" style="display: none;">
...
<!--                                                        <input type="file" accept="image/jpeg, image/png" multiple id="f2"/>
                    ...
                    <div class="portlet-body form">
                      ...
                      <div class="form-body">
                        ...
                        <div class="form-group  " style="margin-bottom: 0px !important;">
                          <label for="d_carin" style="color: #36c6d3;">วันที่เข้าซ่อม <span class="required" style="color: red;">*</span></label> 
                          <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?=date("d-m-Y")?>"  style="width: 100% !important;">
                            <span class="input-group-btn">
                ...
                <div class="col-md-12">
                  <div class="portlet-body form">
                    <div class="form-actions noborder">
                      <a href="re_success.php"> <button type="button" class="btn default"><?=$_SESSION[btn_cancel]?></button></a>
    ...
    <script src="js/action/repair/re_successManage.js?v=1" type="text/javascript"></script>
