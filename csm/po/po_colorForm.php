...
$strSql = " select * ";
$strSql .= " FROM tb_po_color WHERE ref_no = '".$_GET[id]."' ";
$po_color = $db->Search_Data_FormatJson($strSql);



if($po_color[0][d_color_receive] == ''){
	$po_color[0][d_color_receive] = date('d-m-Y');
}else{
	$po_color[0][d_color_receive] = date('d-m-Y',strtotime($po_color[0][d_color_receive]));
}
if($po_color[0][d_color_order] == ''){
	$po_color[0][d_color_order] = date('d-m-Y');
}else{
	$po_color[0][d_color_order] = date('d-m-Y',strtotime($po_color[0][d_color_order]));
}
$strSql = " select * ";
$strSql .= " FROM tb_po_color_order  WHERE ref_no = '".$_GET[id]."' ";
                                                ...
                                                <div class="portlet-body form">
                                                    <div class="form-body">
                                                        <div class="row" style="display: none;">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group form-md-line-input has-success">
                                                                    <input type="text" class="form-control bold" id="s_po_color_ref"  name="s_po_color_ref" value="<?=$_GET['id'];?>">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?= date("d-m-Y") ?>"  style="width: 100% !important;">
                                                                    ...
                                                                    <input type="text" class="form-control" readonly name="d_color_order" id="d_color_order" value="<?=$po_color[0][d_color_order] ?>"  <?= $disableView ?>>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                            <div class="form-group form-md-line-input has-success">
                                                                    <select class="form-control edited bold" id="i_color_shop" name="i_color_shop"  style="color:black;font-weight:bold;">
                                                                        <option value=""><?= $_SESSION[lb_please_select] ?></option>
                                                                        <?php
                                                                        foreach($DDLPartnercomp as $data){
                                                                        	if($data[i_part_comp] == $po_color[0][i_color_shop] ){
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?= date("d-m-Y") ?>"  style="width: 100% !important;">
                                                                    ...
                                                                    <input type="text" class="form-control" readonly name="d_color_receive" id="d_color_receive" value="<?=$po_color[0][d_color_receive] ?>"  <?= $disableView ?>>
                                                                </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                                <div class="form-group form-md-line-input has-success">
                                                                    <select class="form-control edited bold" id="i_color_receive" name="i_color_receive" style="color:black;font-weight:bold;">
                                                                        <option value=""><?= $_SESSION[lb_please_select] ?></option>
                                                                        <?php
                                                                         
                                                                        foreach($DDLEmployee as $data){
                                                                        	if($data[i_emp] == $po_color[0][i_color_receive] ){
																																						$select_ddl = ' selected = "selected"';
																																					}else{
																																						$select_ddl = '';
																																					}
                                                      ...
                                                      <table width="100%" cellpadding="5" cellspacing="10">
                                                      	...
                                                      	if($_dataTable == NULL){
                                                      			...
                                                      			<td>
                                                                    ...
                                                                    <input type="text" class="form-control bold" id="s_po_color_code_<?=$i;?>" name="s_po_color_code[]"  >
                                                                </div>
                                                      			</td>
                                                      			<td>
...
$i = 0;
                                                      			...
                                                      			<td>
                                                      				<div class="form-group form-md-line-input has-success" style="padding-top: 0px;margin-right: 10px;">
                                                                    <input type="text" class="form-control bold" id="s_po_color_code_<?=$i;?>" name="s_po_color_code[]" value="<?=$_dataTable[$key]['s_color_code'];?>" >
                                                                </div>
                                                      			</td>
                                                      			<td>
                                                      				<div class="form-group form-md-line-input has-success" style="padding-top: 0px;">
        ...
        <script src="js/action/po/po_colorForm.js" type="text/javascript"></script>
