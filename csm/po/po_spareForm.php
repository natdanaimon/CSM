...
$strSql .= " FROM tb_customer_car WHERE i_cust_car = '".$_GET[id]."' ";
$customer_car = $db->Search_Data_FormatJson($strSql);

$strSql = " select i_cust_car ";
$strSql .= " FROM tb_customer_car WHERE ref_no = '".$_GET[id]."' ";
$ref_no = $db->Search_Data_FormatJson($strSql);

if($ref_no[0][i_cust_car] > 0){
	$i_cust_car = $ref_no[0][i_cust_car];
	$_GET[id] = $ref_no[0][i_cust_car];
}else{
	//$_GET[id] = '';
	$i_cust_car = $_GET[id];
}
...
$strSql = " select * ";
$strSql .= " FROM tb_po_spare WHERE ref_no = '".$_GET[id]."' ";
$po_spare = $db->Search_Data_FormatJson($strSql);

if($po_spare[0][d_spare_receive] == ''){
	$po_spare[0][d_spare_receive] = date('d-m-Y');
}else{
	$po_spare[0][d_spare_receive] = date('d-m-Y',strtotime($po_spare[0][d_spare_receive]));
}
if($po_spare[0][d_spare_order] == ''){
	$po_spare[0][d_spare_order] = date('d-m-Y');
}else{
	$po_spare[0][d_spare_order] = date('d-m-Y',strtotime($po_spare[0][d_spare_order]));
}
$strSql = " select * ";
$strSql .= " FROM tb_po_spare_order  WHERE ref_no = '".$_GET[id]."' ";
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="portlet box green">
                                        <div class="portlet-title" onclick="closeStep(2)" style="cursor: pointer;">
                                            <div class="caption">
                                                <i class="fa fa-shopping-cart"></i> <?= $_SESSION[po_create_spare] ?></div>
                                            <div class="tools">
                                                <span class="fa fa-angle-down" style="color: white;text-decoration:none;"> </span>
                                            </div>
                                        </div>
                                                ...
                                                <div class="portlet-body form">
                                                    <div class="form-body">
                                                        <div class="row" style="display: none;">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group form-md-line-input has-success">
                                                                    <input type="text" class="form-control bold" id="s_po_spare_ref"  name="s_po_spare_ref" value="<?=$_GET['id'];?>">
                                                            ...
                                                            <div class="row">
                                                            <div class="col-md-6">
                                                                <label for="d_spare_order" style="color: #36c6d3;"><?= $_SESSION[tb_po_orderdate] ?> <span class="required" style="color: red;">*</span></label> 
                                                                <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?= date("d-m-Y") ?>"  style="width: 100% !important;">
                                                                    <span class="input-group-btn">
                                                                    ...
                                                                    <input type="text" class="form-control" readonly name="d_spare_order" id="d_spare_order" value="<?=$po_spare[0][d_spare_order] ?>"  <?= $disableView ?>>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                            <div class="form-group form-md-line-input has-success">
                                                                    <select class="form-control edited bold" id="i_spare_shop" name="i_spare_shop"  style="color:black;font-weight:bold;">
                                                                        <option value=""><?= $_SESSION[lb_please_select] ?></option>
                                                                        <?php
                                                                        foreach($DDLPartnercomp as $data){
                                                                        	if($data[i_part_comp] == $po_spare[0][i_spare_shop] ){
																																						$select_ddl = ' selected = "selected"';
																																					}else{
																																						$select_ddl = '';
																																					}
                                                                        	?>
                                                                        	<option <?=$select_ddl;?> value="<?=$data[i_part_comp];?>"><?=$data[s_comp_th];?></option>
                                                                        	<?php
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <label for="d_spare_receive" style="color: #36c6d3;"><?= $_SESSION[tb_po_receivedate] ?> <span class="required" style="color: red;">*</span></label> 
                                                                <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?= date("d-m-Y") ?>"  style="width: 100% !important;">
                                                                    <span class="input-group-btn">
                                                                    ...
                                                                    <input type="text" class="form-control" readonly name="d_spare_receive" id="d_spare_receive" value="<?=$po_spare[0][d_spare_receive] ?>"  <?= $disableView ?>>
                                                                </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                                <div class="form-group form-md-line-input has-success">
                                                                    <select class="form-control edited bold" id="i_spare_receive" name="i_spare_receive" style="color:black;font-weight:bold;">
                                                                        <option value=""><?= $_SESSION[lb_please_select] ?></option>
                                                                        <?php
                                                                         
                                                                        foreach($DDLEmployee as $data){
                                                                        	if($data[i_emp] == $po_spare[0][i_spare_receive] ){
																																						$select_ddl = ' selected = "selected"';
																																					}else{
																																						$select_ddl = '';
																																					}
                                                                        	?>
                                                                        	<option <?=$select_ddl;?> value="<?=$data[i_emp];?>"><?=$data[s_firstname];?> <?=$data[s_lastname];?></option>
                                                                        	<?php
                                ...
                                <hr />
                                                      <table width="100%" cellpadding="5" cellspacing="10">
                                                      	<tr style="height: 25px; background-color: #32c5d2; color: #ffffff; font-weight: bold;">
                                                      		...
                                                      		<td width="15%" align="center"><?= $_SESSION[purchase_code] ?></td>
                                                      		<td><?= $_SESSION[purchase_name] ?></td>
                                                      		<td width="10%" align="right"><?= $_SESSION[purchase_volume] ?></td>
                                                      		<td width="10%" align="right"><?= $_SESSION[purchase_price] ?></td>
                                                      	...
                                                      	if($_dataTable == NULL){
                                                      			...
                                                      			<td>
                                                      				<div class="form-group form-md-line-input has-success" style="padding-top: 0px;margin-right: 10px;">
                                                                    <input type="text" class="form-control bold" id="s_po_spare_code_<?=$i;?>" name="s_po_spare_code[]"  >
                                                                </div>
                                                      			</td>
                                                      			<td>
                                                      				<div class="form-group form-md-line-input has-success" style="padding-top: 0px;">
                                                                    <input type="text" class="form-control bold" id="s_po_spare_order_<?=$i;?>" name="s_po_spare_order[]" >
                                                                </div>
                                                      			</td>
                                                      			<td>
                                                      				<div class="form-group form-md-line-input has-success" style="padding-top: 0px;margin-left: 10px;">
                                                                    <input type="number" class="form-control bold cal_tr" data-row="<?=$i;?>" id="i_spare_amount_<?=$i;?>" name="i_spare_amount[]" >
                                                                </div>
                                                      			</td>
                                                      			<td>
                                                      				<div class="form-group form-md-line-input has-success" style="padding-top: 0px;margin-left: 10px;">
                                                                    <input type="number" class="form-control bold cal_tr" data-row="<?=$i;?>" id="i_spare_price_<?=$i;?>" name="i_spare_price[]" >
                                                                </div>
                                                      			</td>
...
$i = 0;
                                                      			...
                                                      			<td>
                                                      				<div class="form-group form-md-line-input has-success" style="padding-top: 0px;margin-right: 10px;">
                                                                    <input type="text" class="form-control bold" id="s_po_spare_code_<?=$i;?>" name="s_po_spare_code[]" value="<?=$_dataTable[$key]['s_spare_code'];?>" >
                                                                </div>
                                                      			</td>
                                                      			<td>
                                                      				<div class="form-group form-md-line-input has-success" style="padding-top: 0px;">
                                                                    <input type="text" class="form-control bold" id="s_po_spare_order_<?=$i;?>" name="s_po_spare_order[]" value="<?=$_dataTable[$key]['s_po_spare_order'];?>" >
                                                                </div>
                                                      			</td>
                                                      			<td>
                                                      				<div class="form-group form-md-line-input has-success" style="padding-top: 0px;margin-left: 10px;">
                                                                    <input type="number" class="form-control bold cal_tr" data-row="<?=$i;?>" id="i_spare_amount_<?=$i;?>" name="i_spare_amount[]" value="<?=$_dataTable[$key]['i_spare_amount'];?>" >
                                                                </div>
                                                      			</td>
                                                      			<td>
                                                      				<div class="form-group form-md-line-input has-success" style="padding-top: 0px;margin-left: 10px;">
                                                                    <input type="number" class="form-control bold cal_tr" data-row="<?=$i;?>" id="i_spare_price_<?=$i;?>" name="i_spare_price[]" value="<?=$_dataTable[$key]['i_spare_price'];?>" >
                                                                </div>
                                                      			</td>
                                                      		...
                                                      		<tr>
                                                      			<td colspan="6" style="border-bottom: 1px solid #cccccc;"></td>
																													...
																													$no++;
																													$i++;
																													$total_summm += $_dataTable[$key]['i_spare_amount']*$_dataTable[$key]['i_spare_price'];
																													}
																												}
                                                      	?>
                                                      	</tbody>
        ...
        <script src="js/action/po/po_spareForm.js" type="text/javascript"></script>
        ...
        <script>
        	function add_row_order(){
					...
					function func_cal_tr(row){
						var price = parseInt($('#i_spare_price_'+row).val());
						var amount = parseInt($('#i_spare_amount_'+row).val());
