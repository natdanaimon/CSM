...
$strSql = " select * ";
$strSql .= " FROM tb_po_other WHERE ref_no = '".$_GET[id]."' ";
$po_other = $db->Search_Data_FormatJson($strSql);

if($po_other[0][d_other_receive] == ''){
	$po_other[0][d_other_receive] = date('d-m-Y');
}else{
	$po_other[0][d_other_receive] = date('d-m-Y',strtotime($po_other[0][d_other_receive]));
}
if($po_other[0][d_other_order] == ''){
	$po_other[0][d_other_order] = date('d-m-Y');
}else{
	$po_other[0][d_other_order] = date('d-m-Y',strtotime($po_other[0][d_other_order]));
}
$strSql = " select * ";
$strSql .= " FROM tb_po_other_order  WHERE ref_no = '".$_GET[id]."' ";
                                                ...
                                                <div class="portlet-body form">
                                                    <div class="form-body">
                                                        <div class="row" style="display: none;">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group form-md-line-input has-success">
                                                                    <input type="text" class="form-control bold" id="s_po_other_ref"  name="s_po_other_ref" value="<?=$_GET['id'];?>">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?= date("d-m-Y") ?>"  style="width: 100% !important;">
                                                                    ...
                                                                    <input type="text" class="form-control" readonly name="d_other_order" id="d_other_order" value="<?=$po_other[0][d_other_order] ?>"  <?= $disableView ?>>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                            <div class="form-group form-md-line-input has-success">
                                                                    <select class="form-control edited bold" id="i_other_shop" name="i_other_shop"  style="color:black;font-weight:bold;">
                                                                        <option value=""><?= $_SESSION[lb_please_select] ?></option>
                                                                        <?php
                                                                        foreach($DDLPartnercomp as $data){
                                                                        	if($data[i_part_comp] == $po_other[0][i_other_shop] ){
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?= date("d-m-Y") ?>"  style="width: 100% !important;">
                                                                    ...
                                                                    <input type="text" class="form-control" readonly name="d_other_receive" id="d_other_receive" value="<?=$po_other[0][d_other_receive] ?>"  <?= $disableView ?>>
                                                                </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                                <div class="form-group form-md-line-input has-success">
                                                                    <select class="form-control edited bold" id="i_other_receive" name="i_other_receive" style="color:black;font-weight:bold;">
                                                                        <option value=""><?= $_SESSION[lb_please_select] ?></option>
                                                                        <?php
                                                                         
                                                                        foreach($DDLEmployee as $data){
                                                                        	if($data[i_emp] == $po_other[0][i_other_receive] ){
																																						$select_ddl = ' selected = "selected"';
																																					}else{
																																						$select_ddl = '';
																																					}
                                                      ...
                                                      <table width="100%" cellpadding="5" cellspacing="10">
                                                      	...
                                                      	if($_dataTable == NULL){
                                                      			...
                                                      			<td>
                                                                    ...
                                                                    <input type="text" class="form-control bold" id="s_po_other_code_<?=$i;?>" name="s_po_other_code[]"  >
                                                                </div>
                                                      			</td>
                                                      			<td>
...
$i = 0;
                                                      			...
                                                      			<td>
                                                      				<div class="form-group form-md-line-input has-success" style="padding-top: 0px;margin-right: 10px;">
                                                                    <input type="text" class="form-control bold" id="s_po_other_code_<?=$i;?>" name="s_po_other_code[]" value="<?=$_dataTable[$key]['s_other_code'];?>" >
                                                                </div>
                                                      			</td>
                                                      			<td>
                                                      				<div class="form-group form-md-line-input has-success" style="padding-top: 0px;">
        ...
        <script src="js/action/po/po_otherForm.js" type="text/javascript"></script>
