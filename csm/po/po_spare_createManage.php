...
if ($_GET[id] == NULL && $_GET[func] != "add") {
    echo header("Location: po_spare_createManage.php");
}
                                                ...
                                                <div class="portlet-body form">
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group form-md-line-input has-success">
                                                                    <input type="text" class="form-control bold" id="s_po_spare_ref"  name="s_po_spare_ref" <?= $disableElement ?>>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?= date("d-m-Y") ?>"  style="width: 100% !important;">
                                                                    ...
                                                                    <input type="text" class="form-control" readonly name="d_spare_order" id="d_spare_order" value="<?= date("d-m-Y") ?>"  <?= $disableView ?>>

                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                            <div class="form-group form-md-line-input has-success">
                                                                    <select class="form-control edited bold" id="i_spare_shop" name="i_spare_shop"  <?= $disableElement ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date="<?= date("d-m-Y") ?>"  style="width: 100% !important;">
                                                                    ...
                                                                    <input type="text" class="form-control" readonly name="d_spare_receive" id="d_spare_receive" value="<?= date("d-m-Y") ?>"  <?= $disableView ?>>

                                                                </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                                <div class="form-group form-md-line-input has-success">
                                                                    <select class="form-control edited bold" id="i_spare_receive" name="i_spare_receive"  <?= $disableElement ?>
...
<div class="row">
				...
				$db = new ConnectDB();
        $strSql = " select * ";
        $strSql .= " FROM tb_po_spare_order  WHERE i_po_spare = '".$_GET[id]."' ";
        //$strSql .= " order by u.d_create desc , u.s_status desc ";
         ...
         $_dataTable = $db->Search_Data_FormatJson($strSql);
				...
				$i = 0;
                                                      			...
                                                      			<td align="right">
                                                      				<div class="form-group form-md-line-input has-success" style="padding-top: 0px;margin-left: 10px;">
                                                                    <span id="total_<?=$i;?>"><?=$_dataTable[$key]['i_spare_amount']*$_dataTable[$key]['i_spare_price'];?></span><input type="hidden" id="total_txt_<?=$i;?>" class="quantity" value="<?=$_dataTable[$key]['i_spare_amount']*$_dataTable[$key]['i_spare_price'];?>" />                
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet-body form">
                                            <div class="form-actions noborder">
                                                <a href="po_spare.php"> <button type="button" class="btn default"><?= $_SESSION[btn_cancel] ?></button></a>
        ...
        <script src="js/action/po/po_spare_createManage.js" type="text/javascript"></script>
