document.addEventListener('DOMContentLoaded', function (event) {
	...
	document.querySelector('form input[id=f1]').addEventListener('change', function (event) {
        ...
        document.querySelector('form input[id=f2]').addEventListener('change', function (event) {
		event.preventDefault();
        ...
        document.querySelector('form input[id=f3]').addEventListener('change', function (event) {
		event.preventDefault();
