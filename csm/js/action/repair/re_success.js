...
col_edit += '<a href="re_checkManage.php?func=edit&id=' + item.i_cust_car + '" class="btn btn-circle btn-icon-only green" style="width:32px;height:32px">';
              ...
              col_manage += '<a href="re_successManage.php?func=edit&id=' + item.i_cust_car + '&ref_no='+item.ref_no+'" class="btn btn-circle btn-icon-only blue" style="width:32px;height:32px">';
