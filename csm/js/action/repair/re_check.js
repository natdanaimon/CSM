...
//                var col_dmg = item.i_dmg;
                ...
                col_edit += ' <i class="fa fa-gears"></i>';
                col_edit += '</a>';
...
//                var col_carsub = item.i_sub;
                ...
                col_manage += '<a href="re_checkManageStep2.php?func=edit&id=' + item.i_cust_car + '" class="btn btn-circle btn-icon-only blue" style="width:32px;height:32px">';
