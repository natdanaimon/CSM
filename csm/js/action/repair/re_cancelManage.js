...
function edit() {
    $.ajax({
        type: 'GET',
        url: 'controller/repair/cancelController.php?func=getInfo&id=' + keyEdit,
        beforeSend: function () {
            //$('#se-pre-con').fadeIn(100);
        },
        success: function (data) {
...
function editCheckBoxMain(ref_no) {
    ...
    $.ajax({
        type: 'GET',
        url: 'controller/repair/cancelController.php?func=getCheckBoxMain&ref_no=' + ref_no,
        beforeSend: function () {
            //$('#se-pre-con').fadeIn(100);
        },
        success: function (data) {
...
function editCheckBoxOther(ref_no) {
    ...
    $.ajax({
        type: 'GET',
        url: 'controller/repair/cancelController.php?func=getCheckBoxOther&ref_no=' + ref_no,
        beforeSend: function () {
            //$('#se-pre-con').fadeIn(100);
        },
        success: function (data) {
...
function saveCustomChangeStatus() {
    ...
    $.ajax({
        type: 'GET',
        url: 'controller/repair/cancelController.php?func=edit&status=' + $('#status').val() + '&id=' + $('#id').val(),
        // data: formData,
        cache: false,
        contentType: false,
        processData: false,
