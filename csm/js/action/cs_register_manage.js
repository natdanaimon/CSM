...
//                ChangeDivRefFriend(item.i_seo_by);
                $("#s_ref_deposit").val(item.s_ref_deposit);
...
app.controller('myCtrl', function ($scope) {
    ...
    $scope.changeSelected = function () {
        ...
        if ($("#i_promotion").val() != $scope.tmp || $("#f_special_bonus").val() != $scope.specialbonus) {
            ...
            if ($("#f_special_bonus").val() == "") {
                $("#f_special_bonus").val("0");
            } else {
                var tmpSpecialBonus = parseFloat($("#f_special_bonus").val());
                $("#f_special_bonus").val(tmpSpecialBonus);
            }
