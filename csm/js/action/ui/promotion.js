...
function initialDataTable(first) {
    $.ajax({
        type: 'GET',
        url: 'controller/ui/promotionController.php?func=dataTable',
        beforeSend: function ()
        {
        ...
        success: function (data) {
            ...
            $.each(res, function (i, item) {
                ...
                if (item.s_img_p1 != "") {
                    col_picture = '<a title="' + item.s_img_p1 + '" class="example-image-link" href="upload/promotion/' + item.s_img_p1 + '" data-lightbox="example-' + item.i_promotion + '">';
                    col_picture += '<img class="example-image" src="upload/promotion/' + item.s_img_p1 + '" width="50px" height="50px"  />';
                    col_picture += '</a>';
                }
                ...
                col_edit += '<a href="ui_promotionManage.php?func=edit&id=' + item.i_promotion + '" class="btn btn-circle btn-icon-only blue">';
...
$(document).on('click', '.notifyjs-foo-base .notify-all-yes', function () {
    ...
    $.ajax({
        type: 'GET',
        url: 'controller/ui/promotionController.php',
...
$(document).on('click', '.notifyjs-foo-base .notify-yes', function () {
    ...
    $.ajax({
        type: 'GET',
        url: 'controller/ui/promotionController.php?func=' + func + '&id=' + id,
        beforeSend: function ()
        {
            $('#se-pre-con').fadeIn(100);
        },
