...
function getInfo() {
    $.ajax({
        type: 'GET',
        url: 'controller/ui/popupController.php?func=getInfo',
        beforeSend: function ()
        {
            //$('#se-pre-con').fadeIn(100);
        },
        success: function (data) {
            ...
            $.each(res, function (i, item) {
                ...
                $('#img1').attr('src', (item.s_image != "" ? "upload/popup/" + item.s_image : "images/no_photo.png"));
...
function save() {
    $('#form-action').submit(function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: 'controller/ui/popupController.php',
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
