...
function initialDataTable(first) {
    $.ajax({
        type: 'GET',
        url: 'controller/setting/dmgController.php?func=dataTable',
        beforeSend: function ()
        {
        ...
        success: function (data) {
            ...
            $.each(res, function (i, item) {
                ...
                col_checkbox += '  value="' + item.i_dmg + '" onclick=remove_select_all("checkbox_' + i + '")>';
                ...
                col_edit += '<a href="set_dmgManage.php?func=edit&id=' + item.i_dmg + '" class="btn btn-circle btn-icon-only blue">';
                ...
                col_delete += '<a href="' + (disable != "" ? '#' : 'javascript:Confirm(\'' + item.i_dmg + '\',\'delete\');') + '" class="btn btn-circle btn-icon-only red" ' + disable + '>';
...
$(document).on('click', '.notifyjs-foo-base .notify-all-yes', function () {
    ...
    $.ajax({
        type: 'GET',
        url: 'controller/setting/dmgController.php',
...
$(document).on('click', '.notifyjs-foo-base .notify-yes', function () {
    ...
    $.ajax({
        type: 'GET',
        url: 'controller/setting/dmgController.php?func=' + func + '&id=' + id,
        beforeSend: function ()
        {
            $('#se-pre-con').fadeIn(100);
        },
