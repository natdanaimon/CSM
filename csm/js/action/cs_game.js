...
function initialDataTable(first) {
    $.ajax({
        type: 'GET',
        url: 'controller/gameCSController.php?func=dataTable',
        beforeSend: function ()
        {
...
//                    col_checkbox += ' </label>';
                ...
                col_checkbox += '  value="' + item.i_game + '" onclick=remove_select_all("checkbox_' + i + '")>';
...
$(document).on('click', '.notifyjs-foo-base .notify-all-yes', function () {
    ...
    $.ajax({
        type: 'GET',
        url: 'controller/gameCSController.php',
...
$(document).on('click', '.notifyjs-foo-base .notify-yes', function () {
    ...
    $.ajax({
        type: 'GET',
        url: 'controller/gameCSController.php?func=' + func + '&id=' + id,
        beforeSend: function ()
        {
            $('#se-pre-con').fadeIn(100);
        },
