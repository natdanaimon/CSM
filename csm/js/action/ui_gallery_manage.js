...
function formatState(state) {
    ...
    var $state = $(
            '<span><img src="images/serverMedia/' + state.img + '" width="60px" height="25px" class="img-flag" Style="margin-bottom: 5px;"/><span style="color:black;font-weight:bold;"> ' + state.text + '</span></span>'
            );
    return $state;
}
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(res, function (i, item) {
                ...
                $("#s_color").val(item.s_color);
                $('#s_color').minicolors('settings', item.s_color);
                $("#s_hashtag").val(item.s_hashtag);
