    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(res, function (i, item) {
                ...
                var col_edit = "";
                var col_delete = "";
                var user_base = btoa(item.s_main);
                ...
                col_view += '<a href="http://sbobetsexy.com/v2/index.php?name=turnover&file=admin&id=' + user_base + '" class="btn btn-circle btn-icon-only green" target="_bank">';
