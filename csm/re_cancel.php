                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="re_cancel.php"><?= $_SESSION[re_cancel] ?></a>
                                </li>
                            </ul>
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"><?= $_SESSION[tt_mg_cancel] ?></span>
                                        </div>
                                        <div class="actions">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="all"> <span style="color:red">ความเสียหาย</span> </th>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/repair/re_cancel.js?v=2" type="text/javascript"></script>
        <script>
