...
if ($_GET[id] == NULL && $_GET[func] != "add") {
    echo header("Location: cs_vip_pass.php");
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="cs_vip_pass.php"><?= $_SESSION[vip_pass] ?></a>
                                    <i class="fa fa-circle" style="color:  #00FF00;"></i>
                                </li>
                                <li>
                                    <?= $tt_header ?>
                                            ...
                                            <div class="portlet-body form">
                                                <div class="form-body">
                                                    <div class="form-group form-md-line-input has-success">
                                                        <input type="text" class="form-control bold" id="s_username" name="s_username" <?=$_GET[func]=="edit"?"readonly":""?>>
                                                        <label for="form_control_1"><?= $_SESSION[lb_cs_username_file] ?> <span class="required">*</span></label>          
                                                    </div>
                                                    <div class="form-group form-md-line-input has-success">
                                                        <input type="text" class="form-control bold" id="s_username_login" name="s_username_login" <?=$_GET[func]=="edit"?"readonly":""?>>
                                                        <label for="form_control_1"><?= $_SESSION[lb_cs_username_login] ?> <span class="required">*</span></label>          
                                                    </div>
                                                    <div class="form-group form-md-line-input has-success">
                                                        <input type="text" class="form-control bold" id="s_password" name="s_password">
                                                        <label for="form_control_1"><?= $_SESSION[lb_cs_password] ?> <span class="required">*</span></label>          
                                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="portlet-body form">
                                    <div class="form-actions noborder">
                                        <a href="cs_vip_pass.php"> <button type="button" class="btn default"><?= $_SESSION[btn_cancel] ?></button></a>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
    ...
    <script src="js/action/cs_vip_pass_manage.js" type="text/javascript"></script>
    <script>
