...
<html lang="en">
  ...
  <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
          ...
          <div class="page-content">
            ...
            <div class="page-bar">
              <ul class="page-breadcrumb">
                ...
                <li>
                  <a href="set_compInsurance.php"><?=$_SESSION[comp_insurance]?></a>
                  <i class="fa fa-circle" style="color:  #00FF00;"></i>
                </li>
                <li>
                  <?=$tt_header?>
                    ...
                    <div class="portlet-body form">
                      <div class="form-body">
                        <div class="form-group form-md-line-input has-success">
                          ...
                          <label for="form_control_1"><?=$_SESSION[lb_setInsurance_th]?> <span class="required">*</span></label>          
                        </div>
                        <div class="form-group form-md-line-input has-success">
                          <input type="text" class="form-control bold" id="s_name_display" name="s_name_display" >
                          <label for="s_name_display">ชื่อย่อ <span class="required">*</span></label>          
                        </div>
                        <div class="form-group form-md-line-input has-success">
                  ...
                  <div class="col-md-12">
                    <div class="portlet-body form">
                      <div class="form-actions noborder">
                        <a href="set_compInsurance.php"> <button type="button" class="btn default"><?=$_SESSION[btn_cancel]?></button></a>
    ...
    <script src="js/action/setting/insuranceManage.js?v=1" type="text/javascript"></script>
    <script>
      var keyEdit = "<?=$_GET[id]?>";
    </script>
    <script>
