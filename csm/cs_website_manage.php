...
if ($_GET[id] == NULL && $_GET[func] != "add") {
    echo header("Location: cs_website.php");
}
?>
<!DOCTYPE html>
<html lang="en">
                                        ...
                                        <div class="portlet-body form">
                                            <div class="form-body">
                                                <div class="form-group form-md-line-input has-success">
                                                    <input type="text" class="form-control bold" id="s_website" name="s_website">
                                                    <label for="form_control_1"><?= $_SESSION[lb_cs_website] ?> <span class="required">*</span></label>          
                                                </div>

                                                <div class="form-group form-md-line-input has-success">
                                                    <input type="number" class="form-control bold" id="i_index"  name="i_index" value="0" min="0">
                                                    <label  for="form_control_1"><?= $_SESSION[lb_ui_index] ?> <span class="required">*</span>
                                                    </label>          
                                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet-body form">
                                            <div class="form-actions noborder">
                                                <a href="cs_website.php"> <button type="button" class="btn default"><?= $_SESSION[btn_cancel] ?></button></a>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/cs_website_manage.js" type="text/javascript"></script>
