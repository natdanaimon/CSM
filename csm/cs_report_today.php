                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="cs_report_today.php"><?= $_SESSION[report_today] ?></a>
                                </li>
                            </ul>
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> <?= $_SESSION[tt_mg_report_today] ?></span>
                                        </div>
                                        <div class="actions">
                                            ...
                                            <div class="row">
                                                <form id="form-action">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="col-md-12">
                                                            <div  class="col-md-4">
                                                                <span class="help-block"> <?= $_SESSION[date] ?> </span>
                                                            </div>
...
<!--                                                            <i class="fa fa-minus"></i>-->
                        ...
                        <div id="content-report" style="display: none">
                            <span Style="color: red"><?= $_SESSION[lb_remark_today]?></span>
                            <br/> <br/>
                            <div class="row">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover table-checkable order-column" >
                                                <thead>
                                                    <tr>
                                                        <th colspan='2' align="center"><?= $_SESSION[lb_report_today_rg_sum] ?> 
                                                            <span id="sum-rg"> </span> <?= $_SESSION[lb_rp_user] ?> 
                                                        </th>
                                                    </tr>
                                                    <tr>


                                                        <th align="center">  <?= $_SESSION[tb_co_username] ?> </th>
                                                        <th align="center">  <?= $_SESSION[tb_co_count] ?> </th>
                                    ...
                                    <div class="portlet-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover table-checkable order-column" >
                                                <thead>
                                                    <tr>
                                                        <th colspan='2' align="center"><?= $_SESSION[lb_report_today_dp_sum] ?>
                                                            <span id="sum-dp"> </span> <?= $_SESSION[lb_rp_user] ?> 
                                                        </th>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <div class="portlet-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover table-checkable order-column" >
                                                <thead>
                                                    <tr>
                                                        <th colspan='2' align="center"><?= $_SESSION[lb_report_today_wd_sum] ?>        
                                                            <span id="sum-wd"> </span> <?= $_SESSION[lb_rp_user] ?> 
                                                        </th>
        ...
        <script src="js/action/cs_report_today.js" type="text/javascript"></script>
