...
if ($_GET[id] == NULL && $_GET[func] != "add") {
    echo header("Location: set_auto.php");
}
?>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="portlet light bordered">
                                        ...
                                        <div class="portlet-body form">
                                            <div class="form-body">
                                                <div class="form-group form-md-line-input has-success">
                                                    <input type="text" class="form-control bold" id="s_dept_th" name="s_dept_th" disabled="disabled">
                                                    <label for="form_control_1"><?= $_SESSION[lb_setDetp_th] ?> <span class="required">*</span></label>          
                                                </div>
                                        ...
                                        <div class="portlet-body form">
                                            <div class="form-body">
                                                <div class="form-group form-md-line-input has-success">
                                                    <input type="text" class="form-control bold" id="i_day" name="i_day">
                                                    <label for="form_control_1"><?= $_SESSION[lb_setAuto_day] ?> <span class="required">*</span></label>          
                                                </div>
                                            ...
                                            <div class="portlet-body form">
                                                ...
                                                <div class="form-body">
                                                    <div class="form-group form-md-line-input has-success " style="margin-bottom: 0px !important;">
                                                        <select class="form-control edited bold" id="status" name="status" style="color:black;font-weight:bold;" disabled="disabled">
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet-body form">
                                            <div class="form-actions noborder">
                                                <a href="set_auto.php"> <button type="button" class="btn default"><?= $_SESSION[btn_cancel] ?></button></a>
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/setting/autoManage.js" type="text/javascript"></script>
        <script>
                                                    var keyEdit = "<?= $_GET[id] ?>";
        </script>
        <script>
